...
import { Contract, ledger as organDonorLedger } from './managed/organ_donor/contract/index.js';
...
const PrivateStateId = 'organDonorPrivateState' as const;
...
async function main() {
  ...
  // --- Compile contract ---
  const counterCompiledContract = CompiledContract.make('organ_donor', Contract).pipe(
