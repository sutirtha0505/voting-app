...
const VotingPrivateStateId = "votingPrivateState";
// ---------------------------------------------------------------------------
// Helpers
// ---------------------------------------------------------------------------
const frames = ["⠋", "⠙", "⠹", "⠸", "⠼", "⠴", "⠦", "⠧", "⠇", "⠏"];
...
async function main() {
    ...
    // --- Compile contract ---
    const votingCompiledContract = CompiledContract.make("voting", Contract).pipe(CompiledContract.withVacantWitnesses, CompiledContract.withCompiledFileAssets(zkConfigPath));
    // --- Deploy ---
...
//# sourceMappingURL=deploy-voting.js.map