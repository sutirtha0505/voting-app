...
export class Contract {
        ...
        this.circuits = {
            registerDonor: (...args_1) => {
                ...
                if (!(typeof (contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
                    __compactRuntime.typeError('registerDonor', 'argument 1 (as invoked from Typescript)', 'counter.compact line 34 char 1', 'CircuitContext', contextOrig_0);
                }
                if (!(bloodType_0.buffer instanceof ArrayBuffer && bloodType_0.BYTES_PER_ELEMENT === 1 && bloodType_0.length === 32)) {
                    __compactRuntime.typeError('registerDonor', 'argument 1 (argument 2 as invoked from Typescript)', 'counter.compact line 34 char 1', 'Bytes<32>', bloodType_0);
                }
                if (!(organType_0.buffer instanceof ArrayBuffer && organType_0.BYTES_PER_ELEMENT === 1 && organType_0.length === 32)) {
                    __compactRuntime.typeError('registerDonor', 'argument 2 (argument 3 as invoked from Typescript)', 'counter.compact line 34 char 1', 'Bytes<32>', organType_0);
                }
                if (!(tissueMarkers_0.buffer instanceof ArrayBuffer && tissueMarkers_0.BYTES_PER_ELEMENT === 1 && tissueMarkers_0.length === 32)) {
                    __compactRuntime.typeError('registerDonor', 'argument 3 (argument 4 as invoked from Typescript)', 'counter.compact line 34 char 1', 'Bytes<32>', tissueMarkers_0);
                }
            ...
            deactivateDonor: (...args_1) => {
                ...
                if (!(typeof (contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
                    __compactRuntime.typeError('deactivateDonor', 'argument 1 (as invoked from Typescript)', 'counter.compact line 86 char 1', 'CircuitContext', contextOrig_0);
                }
                if (!(typeof (donorRecord_0) === 'object' && donorRecord_0.bloodType.buffer instanceof ArrayBuffer && donorRecord_0.bloodType.BYTES_PER_ELEMENT === 1 && donorRecord_0.bloodType.length === 32 && donorRecord_0.organType.buffer instanceof ArrayBuffer && donorRecord_0.organType.BYTES_PER_ELEMENT === 1 && donorRecord_0.organType.length === 32 && donorRecord_0.tissueMarkers.buffer instanceof ArrayBuffer && donorRecord_0.tissueMarkers.BYTES_PER_ELEMENT === 1 && donorRecord_0.tissueMarkers.length === 32 && typeof (donorRecord_0.isActive) === 'boolean')) {
                    __compactRuntime.typeError('deactivateDonor', 'argument 1 (argument 2 as invoked from Typescript)', 'counter.compact line 86 char 1', 'struct DonorRecord<bloodType: Bytes<32>, organType: Bytes<32>, tissueMarkers: Bytes<32>, isActive: Boolean>', donorRecord_0);
                }
                const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
                const partialProofData = {
                    input: {
    ...
    _proveCompatibility_0(donorRecord_0, requiredBloodType_0, requiredOrgan_0, requiredMarkers_0) {
        ...
        const bloodMatch_0 = this._equal_0(donorRecord_0.bloodType, requiredBloodType_0);
        const organMatch_0 = this._equal_1(donorRecord_0.organType, requiredOrgan_0);
        const tissueMatch_0 = this._equal_2(donorRecord_0.tissueMarkers, requiredMarkers_0);
...
export const pureCircuits = {
    proveCompatibility: (...args_0) => {
        ...
        if (!(typeof (donorRecord_0) === 'object' && donorRecord_0.bloodType.buffer instanceof ArrayBuffer && donorRecord_0.bloodType.BYTES_PER_ELEMENT === 1 && donorRecord_0.bloodType.length === 32 && donorRecord_0.organType.buffer instanceof ArrayBuffer && donorRecord_0.organType.BYTES_PER_ELEMENT === 1 && donorRecord_0.organType.length === 32 && donorRecord_0.tissueMarkers.buffer instanceof ArrayBuffer && donorRecord_0.tissueMarkers.BYTES_PER_ELEMENT === 1 && donorRecord_0.tissueMarkers.length === 32 && typeof (donorRecord_0.isActive) === 'boolean')) {
            __compactRuntime.typeError('proveCompatibility', 'argument 1', 'counter.compact line 58 char 1', 'struct DonorRecord<bloodType: Bytes<32>, organType: Bytes<32>, tissueMarkers: Bytes<32>, isActive: Boolean>', donorRecord_0);
        }
        if (!(requiredBloodType_0.buffer instanceof ArrayBuffer && requiredBloodType_0.BYTES_PER_ELEMENT === 1 && requiredBloodType_0.length === 32)) {
            __compactRuntime.typeError('proveCompatibility', 'argument 2', 'counter.compact line 58 char 1', 'Bytes<32>', requiredBloodType_0);
        }
        if (!(requiredOrgan_0.buffer instanceof ArrayBuffer && requiredOrgan_0.BYTES_PER_ELEMENT === 1 && requiredOrgan_0.length === 32)) {
            __compactRuntime.typeError('proveCompatibility', 'argument 3', 'counter.compact line 58 char 1', 'Bytes<32>', requiredOrgan_0);
        }
        if (!(requiredMarkers_0.buffer instanceof ArrayBuffer && requiredMarkers_0.BYTES_PER_ELEMENT === 1 && requiredMarkers_0.length === 32)) {
            __compactRuntime.typeError('proveCompatibility', 'argument 4', 'counter.compact line 58 char 1', 'Bytes<32>', requiredMarkers_0);
        }
